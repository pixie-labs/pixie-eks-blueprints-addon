...
This repository contains the source code for the Pixie AddOn for EKS Blueprints. EKS Blueprints is a [CDK](https://aws.amazon.com/cdk/) construct that makes it easy for customers to configure and deploy Pixie as part of a EKS Blueprint cluster on [Amazon EKS](https://aws.amazon.com/eks/). 
...
## License
pixie-eks-blueprints-addon is licensed under the [Apache 2.0](http://apache.org/licenses/LICENSE-2.0.txt) License.
